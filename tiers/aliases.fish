# omp tier aliases — fish 版（由 ~/.omp git 仓库统一管理）
# 新机: fish 配置里加一行 `test -f ~/.omp/tiers/aliases.fish; and source ~/.omp/tiers/aliases.fish`
...
alias omp-glmfo 'omp --config ~/.omp/tiers/config-glm-flash-openai.yml'
